...
import { Database, FileCode, Scale, Rocket, Copyright, ShieldAlert } from 'lucide-react';
...
const services = [
  ...
  { title: 'Recuperação de Redes Sociais', desc: 'Medidas judiciais para reaver contas hackeadas, banidas ou perfis sob sequestro digital.', icon: ShieldAlert },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            <article
              key={i}
              className="fade-in group relative glass-panel p-8 rounded-3xl hover:-translate-y-2 transition-all duration-500 flex flex-col border border-white/5 hover:border-sky-500/30 min-h-[220px]"
            >
